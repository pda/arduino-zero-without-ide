...
#define ILI9341_GAMMA               0x26 // Gamma
#define ILI9341_DISPLAY_OFF         0x28 // Display off
#define ILI9341_DISPLAY_ON          0x29 // Display on
#define ILI9341_COLUMN_ADDR         0x2A // Colomn address
#define ILI9341_PAGE_ADDR           0x2B // Page address
#define ILI9341_RAMWR               0x2C // GRAM
...
#define ILI9341_PIXEL_FORMAT        0x3A // Pixel Format
...
#define ILI9341_POWER1              0xC0 // Power Control 1
#define ILI9341_POWER2              0xC1 // Power Control 2
...
#define ILI9341_3GAMMA_EN           0xF2 // 3 Gamma enable
#define ILI9341_PRC                 0xF7 // Pump ratio control

// Undocumented
#define ILI9341_UNDOCUMENTED_EF     0xEF // Undocumented initialization command
